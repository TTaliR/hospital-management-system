...
public class Department implements Serializable {
	...
	public Department(int number, String name, Doctor manager, String location
		...
		this.staffMembersList.add(this.manager);
	...
	public boolean addStaffMember(StaffMember staffMember) {
	    ...
	    if ((staffMember instanceof IntensiveCareNurse || staffMember instanceof IntensiveCareDoctor) && this.getSpecialization().equals(Specialization.IntensiveCare)
	    		&& staffMember.getDepartments().contains(this)) {
		        return false;
		    }
